...
public class LIFEMAP_CONST {
    ...
    public static final String TABLE_NAME_USER_ROLE = "lm_user_role";
    public static final String TABLE_NAME_PERMISSION = "lm_permission";
    ...
    public static final String TABLE_NAME_EVENT_RESPONSE = "lm_event_response";
    public static final String TABLE_NAME_EXPORTED_EVENT = "lm_exported_event";
    public static final String TABLE_NAME_REGION = "lm_region";
    ...
    public static final int FILTER_STATUS_NONE = 0;
    public static final int FILTER_STATUS_ACTUAL = 1;
    public static final int FILTER_STATUS_ALL = 2;
    public static final int FILTER_STATUS_OWN = 3;
    public static final int FILTER_STATUS_MODERATED = 4;
